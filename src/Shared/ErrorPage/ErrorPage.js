    ...
    return (
        ...
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
            <div className="flex items-center flex-col text-center text-white">
                    <img className='w-full rounded-t-lg' src='https://api.time.com/wp-content/uploads/2014/10/hot-dot.png' alt="" srcset="" />
               
                <p className="text-4xl font-semibold md:text-3xl py-5">Sorry, we couldn't find <br /> this page.</p>
